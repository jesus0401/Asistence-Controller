...
export default function Login({ onLogin }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", background: T.black, fontFamily: "Nunito, sans-serif" }}>
      ...
      <div style={{
        ...
        // Oculto en móvil
        cssText: "@media(max-width:768px){display:none}",
      }}
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", background: T.dark1 }}>
        <div style={{ width: "100%", maxWidth: "380px" }}>

          {/* Logo visible solo en móvil */}
          <div className="login-mobile-logo" style={{ display: "none", flexDirection: "column", alignItems: "center", marginBottom: "32px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "6px" }}>
              ...
              <span style={{ color: T.yellow, fontSize: "36px", fontFamily: "Bebas Neue, sans-serif", letterSpacing: "3px" }}>SOLGYM</span>
            </div>
